...
export class SystemSettingsService {
  ...
  async updateSettings(dto: { contactWhatsapp?: string; contactEmail?: string; leadFormEnabled?: boolean }) {
  ...
  async createLead(dto: { name: string; email?: string; phone?: string; message?: string }) {
