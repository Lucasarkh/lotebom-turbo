      ...
      teaserLots = available.slice(0, 6).map((l: any) => {
        ...
        return {
          ...
          lotDetails: {
            ...
            hasViela: override?.hasViela ?? false,
            vielaWidth: override?.vielaWidth ?? null,
            vielaSide: override?.vielaSide ?? null,
            recuoFrontal: override?.recuoFrontal ?? null,
            recuoLateral: override?.recuoLateral ?? null,
            recuoFundos: override?.recuoFundos ?? null,
            taxaOcupacao: override?.taxaOcupacao ?? null,
            coeficienteAproveitamento: override?.coeficienteAproveitamento ?? null,
            gabaritoMaximo: override?.gabaritoMaximo ?? null,
            taxaPermeabilidade: override?.taxaPermeabilidade ?? null,
            zoneamento: override?.zoneamento ?? null,
            usoPermitido: override?.usoPermitido ?? null,
            matricula: override?.matricula ?? null,
            inscricaoImobiliaria: override?.inscricaoImobiliaria ?? null,
            confrontacoes: override?.confrontacoes ?? null,
          }
        };
      });
    } else {
          ...
          select: {
            ...
            lotDetails: {
              select: {
                ...
                recuoFundos: true,
                taxaOcupacao: true,
                coeficienteAproveitamento: true,
                gabaritoMaximo: true,
                taxaPermeabilidade: true,
                zoneamento: true,
                usoPermitido: true,
                matricula: true,
